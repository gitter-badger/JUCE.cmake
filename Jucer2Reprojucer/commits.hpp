...
inline bool getCommitFeature(CommitFeature feature, unsigned long commitSha1)
{
  switch (commitSha1)
  {
  ...
  case 0xa85f026: /* | o BLOCKS documentation improvements                              */
    return getCommitFeature(feature, 0xefd4bb6);
  ...
  case 0x4fa0516: /* | o Revised multibus API and added support for multibus hosting    */
    return getCommitFeature(feature, 0xebf19aa);
  ...
  case 0x9f31d64: /* | o Use a bespoke VST2 interface                                   */
    if (feature == CommitFeature::hasVst2Interface)
      return true;
  ...
  case 0x0a4b2ae: /* | o Return parent row number if any of the tree view item's par... */
    return getCommitFeature(feature, 0x630ab88);
  ...
  case 0xfe37653: /* | o Fixed JUCE_BUILDNUMBER which was not correctly updated to 4... */
    return getCommitFeature(feature, 0x2c7a0e0);
  ...
  case 0x70949aa: /* o Added several new features: support for AudioUnit v3, new sim... */
    switch (feature)
    {
    case CommitFeature::isSupported:
      return true;
  ...
  return getCommitFeature(feature, kDefaultCommitSha1);
}
