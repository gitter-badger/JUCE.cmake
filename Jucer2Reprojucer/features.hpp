...
struct Features
{
  Version juceVersion;     // from JUCE/modules/juce_core/system/juce_StandardHeader.h
  Version projucerVersion; // from JUCE/extras/Projucer/Projucer.jucer
};


static const std::uint32_t kDefaultCommitSha1 = 0x75cd666;


Features getJuceAndProjucerFeatures(const std::uint32_t commitSha1)
{
  switch (commitSha1)
  {
  ...
  case 0xe0aff60: /* | o Bump version number to 4.3.1                                   */
    return {Version{4, 3, 1}, Version{4, 3, 1}};
  ...
  case 0x363ceb0: /* | o Bump version number to 4.3.0                                   */
    return {Version{4, 3, 0}, Version{4, 3, 0}};
  ...
  case 0x4eb8933: /* | o Bump version number to 4.2.4                                   */
    return {Version{4, 2, 4}, Version{4, 2, 4}};
  ...
  case 0x630ab88: /* o Version number update                                            */
    return {Version{4, 2, 3}, Version{4, 2, 3}};
  ...
  case 0xb46be0f: /* o Change projucer version to match JUCE version                    */
    return {Version{4, 2, 2}, Version{4, 2, 2}};
  ...
  case 0xfe37653: /* | o Fixed JUCE_BUILDNUMBER which was not correctly updated to 4... */
    return {Version{4, 2, 2}, Version{4, 2, 1}};
  ...
  case 0x0b3a11e: /* o Updated version number to 4.2.1                                  */
    return {Version{4, 2, 1}, Version{4, 2, 1}};
  ...
  case 0x70949aa: /* o Added several new features: support for AudioUnit v3, new sim... */
    return {Version{4, 2, 0}, Version{4, 2, 0}};
  }

  std::cout << "No commit found with the SHA-1 \"" << std::hex << commitSha1
            << "\", falling back to the default commit (" << kDefaultCommitSha1 << ")"
            << std::endl;

  return getJuceAndProjucerFeatures(kDefaultCommitSha1);
}
